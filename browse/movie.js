...
const showmoviecard = (genre, title) => {
    var clicked = document.getElementById(genre)
        ...
        .then(function (data) {
            switch (genre) {
                ...
                case "drama":
                    ...
                    break;
                case "fantasy":
                    var mydata = data[2].fantasy
                    break;
                case "action":
                    var mydata = data[3].action
                    break;
                case "romance":
                    var mydata = data[4].romance
                    break;
                case "thriller":
                    var mydata = data[5].thriller
                    break;
            }
            var idx = 0
            for (var i = 0; i < 11; i++) {
            ...
            clicked.innerHTML =
                ...
                <div class="card-left">
                    ...
                    <div class="contents">
                    <video controls >
                    <source src="Oscar Nominated 3D Animated Shorts Sweet Cocoon - by ESMA  TheCGBros.mp4" type="video/mp4">
